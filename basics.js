...
myPhone = 7654321;
let myArr = [1, 2, 3, 4 ,5];
let isHuman = true;     // true or false in lowercase
...
let schools = ["RI", "ASR", "EJC", "ACJC", "HCI"]
...
// Objects (dictionary in Python, also exactly the same)
let person = {
    firstName: "Maadhesh",
    lastName: "Vetrimani",
    age: 17,
...
console.log(person.age);        // alternative to using [], n dont need use "" !!
